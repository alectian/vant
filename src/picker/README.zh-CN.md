...
```html
<icloudata-picker title="标题" :columns="columns" :default-index="2" />
```
...
```html
<icloudata-picker title="标题" :columns="columns" />
```
...
```html
<icloudata-picker ref="picker" :columns="columns" @change="onChange" />
```
...
```html
<icloudata-picker :columns="columns" :loading="loading" />
```
