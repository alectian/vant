...
```html
<icloudata-cell title="选择单个日期" :value="date" @click="show = true" />
...
```html
<icloudata-cell title="选择多个日期" :value="text" @click="show = true" />
...
```html
<icloudata-cell title="选择日期区间" :value="date" @click="show = true" />
